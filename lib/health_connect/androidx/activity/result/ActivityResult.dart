...
class ActivityResult extends jni$_.JObject {
  ...
  static final _class =
      jni$_.JClass.forName(r'androidx/activity/result/ActivityResult');
  ...
  /// The returned object must be released after use, by calling the [release] method.
  factory ActivityResult(
    int i,
    intent$_.Intent? intent,
  ) {
    final _$intent = intent?.reference ?? jni$_.jNullReference;
    return ActivityResult.fromReference(_new$(_class.reference.pointer,
            _id_new$ as jni$_.JMethodIDPtr, i, _$intent.pointer)
        .reference);
  }
  ...
  /// from: `public android.content.Intent getData()`
  /// The returned object must be released after use, by calling the [release] method.
  intent$_.Intent? getData() {
  ...
  static final _resultCodeToString = jni$_.ProtectedJniExtensions.lookup<
              jni$_.NativeFunction<
                  jni$_.JniResult Function(jni$_.Pointer<jni$_.Void>,
  ...
  /// from: `static public java.lang.String resultCodeToString(int i)`
  /// The returned object must be released after use, by calling the [release] method.
  static jni$_.JString resultCodeToString(
    int i,
  ) {
    return _resultCodeToString(_class.reference.pointer,
            _id_resultCodeToString as jni$_.JMethodIDPtr, i)
